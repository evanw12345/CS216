...
template <typename T>
void SortingList<T>::selection_sort(int (*compare)(const T &t1, const T &t2))
{
    size_t min_index = 0;
...
template <typename T>
void SortingList<T>::bubble_sort(int (*compare)(const T &t1, const T &t2))
{
...
template <typename T>
void SortingList<T>::merge_sort(int (*compare)(const T &t1, const T &t2))
{
...
// helper functions
template<typename T>
void SortingList<T>::merge(int first, int mid, int last, int (*compare)(const T &t1, const T &t2))
{
...
template<typename T>
void SortingList<T>::merge_sortHelper(int min, int max, int (*compare)(const T &t1, const T &t2))
{
    if (min < max)
    {
        int mid = (min + max) / 2;
